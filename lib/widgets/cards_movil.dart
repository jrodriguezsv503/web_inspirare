...
class NosotrosMovil extends StatelessWidget {
  const NosotrosMovil({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.stars_rounded, color: Palette.primary, size: 28),
...
class HistoriesMovil extends StatelessWidget {
  const HistoriesMovil({super.key});
...
// Widget para testimonios móvil
class _TestimonioCardMovil extends StatelessWidget {
  final String logoPath;
  final String testimonio;
  final String autor;
  final String empresa;

  const _TestimonioCardMovil({
      ...
      child: Column(
        children: [
          ...
          ClipRRect(
            ...
            child: Image.asset(logoPath, width: 80, fit: BoxFit.cover),
          ),
          const SizedBox(height: 12),
          // Ícono de comillas
          Icon(Icons.format_quote, color: Palette.primary, size: 28),
          const SizedBox(height: 8),
          // Testimonio
          Text(
            testimonio,
...
class ProductMovil extends StatelessWidget {
  const ProductMovil({super.key});
...
// Widget para servicios móvil
class _ServicioCardMovil extends StatelessWidget {
  final IconData icon;
  final String titulo;
  final String descripcion;

  const _ServicioCardMovil({
    required this.icon,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Icon(icon, color: Palette.primary, size: 32),
          ),
          const SizedBox(height: 12),
          // Título
          Text(
...
class ContactMovil extends StatelessWidget {
  const ContactMovil({super.key});
